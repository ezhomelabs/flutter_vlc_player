...
public class Media extends VLCObject<IMedia.Event> implements IMedia {
    ...
    public Media(ILibVLC ILibVLC, HaicamRequest req) {
        super(ILibVLC);
        nativeNewFromHaicamCallbacks(ILibVLC, req.type, req.accountId, req.cameraId);
        mUri = VLCUtil.UriFromMrl(nativeGetMrl());
    }
    ...
    private native void nativeNewFromHaicamCallbacks(ILibVLC ILibVLC, int type, long accountId, long cameraId);
